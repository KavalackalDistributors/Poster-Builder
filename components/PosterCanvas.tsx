...
const PosterCanvas = forwardRef<HTMLDivElement, PosterCanvasProps>(({ poster, image, loading, hasStarted }, ref) => {
  const isSplit = poster.layout === 'split';
  return (
    <div className="relative poster-scale max-w-[800px] overflow-hidden rounded-[2rem] shadow-glow ring-1 ring-black/5">
      <div
        ref={ref}
